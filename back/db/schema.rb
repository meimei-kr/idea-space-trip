...
ActiveRecord::Schema[7.1].define(version: 2024_03_12_124126) do
  ...
  create_table "theme_answers", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.text "answer", null: false
    t.bigint "idea_session_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["idea_session_id"], name: "index_theme_answers_on_idea_session_id"
  end
  ...
  add_foreign_key "theme_answers", "idea_sessions"
end
